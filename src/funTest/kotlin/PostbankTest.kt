...
class PostbankTest : StringSpec({
    ...
    "Demokonto account statement is parsed correctly" {
        ...
        val expectedJson = gson.fromJson<JsonArray>(expectedText)

        val actualText = PostbankPDFParser.parse("PB_KAZ_KtoNr_9999999999_06-04-2017_1200.pdf").toString()
        val actualJson = gson.fromJson<JsonArray>(actualText)
    ...
    "Goran Bolsec account statement is parsed correctly" {
        ...
        val actualText = PostbankPDFParser.parse("317970916-PB-KAZ-KtoNr-0914083113-03-06-2016-0313.pdf").toString()
        val actualJson = gson.fromJson<JsonArray>(actualText)
